                ...
                <client-only>
                    ...
                    >
                        <ul class="relative space-y-0.5 px-4 pt-10 py-0 font-semibold">
                            <h2 class="-mx-4 mb-1 flex items-center bg-[#128D2A]/[0.9] px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                            ...
                            <li class="menu nav-item">
                                ...
                                >
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-white-light ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{{ $t('users') }}</span>
                                    </div>
